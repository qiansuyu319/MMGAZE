...
python create_face_maps_faceMap.py --tracks $tracks_dir --video $videofile --scores $scores_dir --out_video $out_video --maps_out $face_maps_dir  --bboxes_out $head_boxes_dir --reference $ref_name 