...
parser.add_argument('--initial_model', type=str, default='/root/MMGaze_VGS/utils/Speaker_detector/speaker_detect/data/syncnet_v2.model', help='Path to the pretrained SyncNet model')
